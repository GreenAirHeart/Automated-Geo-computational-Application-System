...
# a=get_ontology("H:/geomorphology/ontology/Reasoning_geomorphic_classification_system_MODELs.owl").load()
# # env.workspace = "H:/geomorphology/following_NNU/geomorphic_following/PROJECT"
# # arcpy.CheckOutExtension("Spatial")
# work_space="H:/geomorphology/following_NNU/geomorphic_following/PROJECT/"
# raw_data_space="H:/geomorphology/material_from_NNU/Model and Data/preData/"
#
# on_class=a.classes()
...
# l_data_property=list(on_data_property)
# l_rules=list(on_rule)
# l_anxioms=list(on_anxioms)
# l_ndividual=list(on_individual)
# # print(l_class)
# # print(l_object_property)
# # print(l_data_property)
# # print(l_anxioms)
# # print(l_ndividual[89])
# # f = open('H:/geomorphology/following_NNU/geomorphic_following/13.txt', 'w')
# # for i in l_ndividual:
# #     f.write(str(i) + '\n')
...
# model_name = 'Identify_water_net'
# # 'Division_of_mountain_unit'
# input=kg_input(model_name)
# print(input[0]['Projected_DEM'],input[1])
