...
# Read the TTL file
with open('H:/SHACL/shacl-params/shacl-params/data/raster_graph_CHINADEM_90.ttl', 'r') as file:
...
with open('H:/SHACL/shacl-params/shacl-params/data/raster_graph_CHINADEM_90_1.ttl', 'w') as file:
